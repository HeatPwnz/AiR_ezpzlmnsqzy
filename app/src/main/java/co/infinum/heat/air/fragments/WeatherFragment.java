...
public class WeatherFragment extends Fragment {
    ...
    //pokreće dretvu, poziva getJSON iz RemoteFetch klase, ako je getJSON=null display error, ako ne
    //pokreće metodu renderWeather
    private void updateWeatherData(final String city){
        new Thread(){
            public void run(){
                final JSONObject json = RemoteFetch.getJSON(getActivity(), city);
                Log.d("Json ", city);
                //Log.d("JSOOOOON ---------", json.toString());
                if(json == null){
    ...
    ///koristi JSON podatke kako bi updateala TextView objekte
    private void renderWeather(JSONObject json){
        try {
            ...
            //isprobavanje.setText(String.format("%.2f", main.getDouble("temp")) + " ℃");
